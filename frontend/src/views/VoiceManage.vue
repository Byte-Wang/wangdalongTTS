<template>
  <div class="page-container">
    <div class="flex justify-between items-center" style="margin-bottom:20px">
      ...
      <button class="btn btn-primary" @click="showClonePanel = !showClonePanel">
        {{ showClonePanel ? '收起' : '+ 创建克隆音色' }}
      </button>
    </div>

    <!-- 克隆音色面板 -->
    <div v-if="showClonePanel" class="card" style="margin-bottom:24px">
      <h3 style="margin-bottom:16px">声音复刻</h3>
      ...
      <div class="form-group">
        ...
        <div v-for="(t, i) in cloneTexts" :key="i"
          :class="['voice-card', { active: cloneForm.text === t }]"
      ...
      <button class="btn btn-primary" :disabled="!canClone || cloning" @click="doClone" style="width:100%">
    ...
    <div v-if="userVoices.length > 0" class="card">
      <h3 style="margin-bottom:16px">我的音色（{{ userVoices.length }}）</h3>
      <table class="table">
        <thead>
