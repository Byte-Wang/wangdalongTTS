...
将上一步返回的 `voice_id` 填入实时语音对话 `session.update` 事件的 `voice` 参数中，详见[音色配置](https://help.aliyun.com/zh/model-studio/qwen-audio-realtime-user-guides#fc60h311)。
...
CosyVoice 声音复刻支持华北2（北京）地域（v3.5/v3/v2/v1 系列）和新加坡地域（v3 系列）。
